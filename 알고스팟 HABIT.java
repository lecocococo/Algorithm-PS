// https://hongjw1938.tistory.com/44 참고
import java.io.*;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        ...
        for(int z = 0;z < C; z++){
            ...
            int result = longestFrequent(K, st);
...
//    }
    ...
    public static int longestFrequent(int k, String s){
        ArrayList<Integer> a = makeSuffixArray(s);
        int result = 0;
        for(int i = 0;i+k<s.length();i++){
            result = Math.max(result, commonPrefix(s,a.get(i),a.get(i+k-1)));
        }
        return result;
    }
}
